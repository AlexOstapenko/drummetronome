...
/////////////////////////////////////////////////
function replaceString(content, searchString, replacement) {
  let index = content.indexOf(searchString);
  while (index !== -1) {
    content = content.substring(0, index) + replacement + content.substring(index + searchString.length);
    index = content.indexOf(searchString, index + replacement.length);
  }
  return content;
}
